...
int main()
{
    ...
    char *ptr1 = "Neue CD anlegen",*ptr2 = "CD bearbeiten", *ptr3 = "CD loeschen", *ptr4 = "Suchen", *ptr5 = "Auflisten", *ptr6 = "Programm beenden";
    char *menuPoints[] = {ptr1, ptr2, ptr3, ptr4, ptr5, ptr6};
